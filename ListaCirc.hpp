...
=======
/* Copyright[2015] <osé Victor Feijó de Araujo>
...
public:
    // Tail aponta para head, ou seja o ultimo elemento da lista
    // Construtor inicializa as variáveis size = 0, head = NULL, tail = NULL
	ListaCirc() : size(0), head(NULL), tail(NULL) {}
...
// head = primeiro elemento da lista
// size = tamanho da lista
// tail = aponta para head( ultimo elemento)
private:
	Elemento<T>* head;
	Elemento<T>* tail;
	int size;
